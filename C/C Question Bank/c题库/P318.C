...
int main(void)
{
	...
	printf("\ncha zhao qing kuang:\n");
	fp = fopen("sp38.dat", "rb"); //打开二进制文件sp38.dat
	
	/* 判断文件sp38.dat是否被打开，fp等于NULL，则文件打不开，否则，文件被打开 */
	if (NULL == fp)
	{
